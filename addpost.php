<?php
session_start(); $_SESSION['Referrer'] = 'addpost.php';
    ...
    <div class='centerpost'>
        ...
        <div class='form'>
            <form action='<?=$_SERVER['PHP_SELF']?>' method='post' enctype="multipart/form-data" id='addpost'>
                <label id='input' for='file_img' class='addpost'>Название: </label><input type='text' class='addpostname' required minlength="20" maxlength='140' autofocus name='addPostName' placeholder="Добавьте название. Количество символов: от 20 до 140"><br>
                <label id='input' for='file_img' class='addpost'>Автор: </label><input type='text' class='addpostauthor' required minlength="3" maxlength='40' name='addPostAuthor' placeholder="Имя автора или его псевдоним. Количество символов: от 3 до 40" value='<?=$_SESSION['Fio']?>'> 
                ...
                <br><textarea class='text' required minlength="20" maxlength='4000' spellcheck="true" name='addPostContent' placeholder="Добавление содержания. Количество символов: от 20 до 4000 с пробелами" id='content'></textarea><br>
