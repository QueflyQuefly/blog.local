<?php // needed $comment:array, $linkToDelete:string ?>
            <div class='viewcomment' id='comment<?= $comment['comment_id'] ?>'>
                <p class='commentauthor'>
                    <a class='menuLink' href='/cabinet/?user=<?= $comment['user_id'] ?>'><?= $comment['author'] ?></a>
                ...
                <div class='like'>
                    <form action='<?= $_SESSION['referrer'] ?>#comment<?= $comment['comment_id'] ?>' method='post'>
