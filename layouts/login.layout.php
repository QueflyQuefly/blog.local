    <div class='formentry'>
        ...
        <form action='/login' method='post'>
            <label class='formlabel'>Введите вашу почту: <input type='email' name='email' required minlength="1" maxlength='50' autofocus autocomplete="on" placeholder='Ваш email' class='formtext'></label>
            <label class='formlabel'>Придумайте пароль: <input type='password' name='password' required minlength="1" maxlength='20' autocomplete="off" placeholder='Ваш пароль' class='formtext'></label>
